 ...
 *
 */
	public class ServerUIFrame extends JFrame {
	    // Constants
	    //////////////////////////////////
	    ...
	    //////////////////////////////////
	    	...
	    	Box box_buttons;
	    	JPanel pnl_numHosts = new JPanel();
	    	BorderLayout borderLayout3 = new BorderLayout();
	    	JLabel lbl_numHosts = new JLabel();
	    	Box box_numHosts;
	    	JLabel lbl_hostCount = new JLabel();
	    	JSlider slide_numHosts = new JSlider();
	    	...
	    	JLabel lbl_simulationState = new JLabel();
		    Box box1;
	    ...
	    //////////////////////////////////
	    	...
	    	public ServerUIFrame( DHCPServer owner ) {
			try {
		    	jbInit();
			}
			catch(Exception e) {
	    ...
	    //////////////////////////////////
	    	...
	    	private void jbInit() throws Exception {
				...
				box_numHosts = Box.createHorizontalBox();
				...
				pnl_numHosts.setLayout(borderLayout3);
								
				lbl_numHosts.setText("No. of Hosts:");
								
				lbl_hostCount.setMaximumSize(new Dimension(30, 17));
				lbl_hostCount.setMinimumSize(new Dimension(30, 17));
				lbl_hostCount.setPreferredSize(new Dimension(30, 17));
				lbl_hostCount.setText("1");
								
				slide_numHosts.setValue(1);
				slide_numHosts.setMaximum(253);
				slide_numHosts.addChangeListener(new javax.swing.event.ChangeListener() {
			    	public void stateChanged(ChangeEvent e) {
			        	slide_numHosts_stateChanged(e);
			    	}
				});
				...
				jLabel1.setText("Simulation state: ");
				...
				jLabel4.setText("Maduro Chupalo: ");
				
				
				lbl_simulationState.setBackground(Color.white);
				lbl_simulationState.setText("Not started");
				...
				pnl_main.add(lbl_simulationState, null);
				...
				this.getContentPane().add(pnl_numHosts, BorderLayout.NORTH);
				
				pnl_numHosts.add(box_numHosts, BorderLayout.CENTER);
				pnl_numHosts.setBorder( BorderFactory.createCompoundBorder( BorderFactory.createEtchedBorder(), BorderFactory.createEmptyBorder( 2, 2, 2, 2 ) ) );
				
				box_numHosts.add(lbl_numHosts, null);
				box_numHosts.add(slide_numHosts, null);
				box_numHosts.add(lbl_hostCount, null);
				...
				lbl_simulationState.setForeground( Color.black );
	    	...
	    	/**
	     	* When the slider for the num hosts changes, we update the label.
	     	*/
	    	void slide_numHosts_stateChanged(ChangeEvent e) {
	    		lbl_hostCount.setText( Integer.toString( slide_numHosts.getValue() ) );
	    	}
			...
			m_owner.addBehaviour( new OneShotBehaviour() {
		                          	public void action() {
		                              	((DHCPServer) myAgent).inviteHosts( slide_numHosts.getValue() );
		                          	}
		                      	} );
	    	}
	    	...
	    	/**
	     	* When the user clicks on stop, tell the Server to stop the simulation.
	     	*/
			...
			m_owner.addBehaviour( new OneShotBehaviour() {
		                          	public void action() {
		                              	((DHCPServer) myAgent).endSimulation();
		                          	}
		                      	} );
	    	}
			...
			slide_numHosts.setEnabled( !starting );
			btn_Exit.setEnabled( !starting );
	    	}


	    	/**
	     	* When the user clicks the exit button, tell the Server to shut down.
	     	*/
	   	 void btn_Exit_actionPerformed(ActionEvent e) {
			m_owner.addBehaviour( new OneShotBehaviour() {
		                          	public void action() {
		                              	((DHCPServer) myAgent).terminateServer();
		                          	}
		                      	} );
	    	}
